...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=MySynthesiser Demo Installer\n"
      else:
        line="OutputBaseFilename=MySynthesiser Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the MySynthesiser Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the MySynthesiser installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=MySynthesiser Demo installer\n"
     else:
       line="SetupWindowTitle=MySynthesiser installer\n"
