...
MySynthesiser::MySynthesiser(const InstanceInfo &info)
...
#if IPLUG_DSP
void MySynthesiser::ProcessBlock(sample **inputs, sample **outputs, int nFrames)
{
...
void MySynthesiser::ProcessMidiMsg(const IMidiMsg &msg)
{
  mSynth.AddMidiMsgToQueue(msg);
}

void MySynthesiser::OnReset()
{
  mSynth.SetSampleRateAndBlockSize(GetSampleRate(), GetBlockSize());
}

void MySynthesiser::OnParamChange(int paramIdx)
{
